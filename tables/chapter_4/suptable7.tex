\begin{table}[h!]
    ...
    \caption{Adjusted Rand (\ac{AR}) values for the clustering methods used in the analysis of 2,006 genetically diverse \textit{S. pyogenes} isolates recovered worldwide [Dataset 2 \cite{friaes_supplemental_2023}].}
