\begin{table}[h!]
    ...
    \caption{Adjusted Wallace (\ac{AW}) values (95\% confidence intervals) for the clustering methods used in the analysis of 265 \textit{S. pyogenes} isolates recovered in Portugal [Dataset 1 \cite{friaes_supplemental_2023}].}
