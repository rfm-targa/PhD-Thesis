\begin{table}[h!]
    \caption[Mean values for the total number of coding sequences (CDSs), distinct number of CDSs, and percentage of total CDSs that are distinct for each species' datasets.]{Mean values for the total number of coding sequences (\ac{CDSs}), distinct number of \ac{CDSs}, and percentage of total \ac{CDSs} that are distinct for each species' datasets.}
